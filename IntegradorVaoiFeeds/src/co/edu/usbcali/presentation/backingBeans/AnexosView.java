...
private IBusinessDelegatorView businessDelegatorView;
	...
	public void listener_txtId(){
	    ...
	    try {
	    	        Long codigoAnexo = FacesUtils.checkLong(txtCodigoAnexo);
	    	    	entity = codigoAnexo != null ? businessDelegatorView.getAnexos(codigoAnexo) : null;
	    } catch (Exception e) {
	    	entity = null;
	    }
		...
		if(entity==null){
	    	        ...
	    	        txtCodigoArti_Articulos.setDisabled(false);
		    		        ...
		    		        txtFormato.setValue(entity.getFormato());txtFormato.setDisabled(false);
		    		        txtNombre.setValue(entity.getNombre());txtNombre.setDisabled(false);
		    		        txtUrl.setValue(entity.getUrl());txtUrl.setDisabled(false);
		    		        txtCodigoArti_Articulos.setValue(entity.getArticulos().getCodigoArti());txtCodigoArti_Articulos.setDisabled(false);
		    		    		        txtCodigoAnexo.setValue(entity.getCodigoAnexo());txtCodigoAnexo.setDisabled(true);
		    		    btnSave.setDisabled(false);
		    if(btnDelete!=null){
	...
	public String action_edit(ActionEvent evt){
    	...
    	selectedAnexos = (AnexosDTO)(evt.getComponent().getAttributes().get("selectedAnexos"));		
            txtArchivo.setValue(selectedAnexos.getArchivo());txtArchivo.setDisabled(false);
            txtFormato.setValue(selectedAnexos.getFormato());txtFormato.setDisabled(false);
            txtNombre.setValue(selectedAnexos.getNombre());txtNombre.setDisabled(false);
            txtUrl.setValue(selectedAnexos.getUrl());txtUrl.setDisabled(false);
            txtCodigoArti_Articulos.setValue(selectedAnexos.getCodigoArti_Articulos());txtCodigoArti_Articulos.setDisabled(false);
                txtCodigoAnexo.setValue(selectedAnexos.getCodigoAnexo());txtCodigoAnexo.setDisabled(true);
            btnSave.setDisabled(false);
    	setShowDialog(true);
        	...
        	entity = new Anexos();
	    	        ...
	    	        Long codigoAnexo = FacesUtils.checkLong(txtCodigoAnexo);
                        ...
                        entity.setArchivo(FacesUtils.checkString(txtArchivo));
                            ...
                            entity.setArticulos(FacesUtils.checkLong(txtCodigoArti_Articulos) != null ? businessDelegatorView.getArticulos(FacesUtils.checkLong(txtCodigoArti_Articulos)) : null );
